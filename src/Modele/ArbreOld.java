...
public class ArbreOld {
    ...
    public ArbreOld(Jeu jeuCourant, Coup coupDeParent, boolean isMaximizingPlayer){
    ...
    float Search(int depth){
        ...
        if(isMaximizingPlayer){
            ...
            for(int i = 0; i < moves.size(); i++) {
                ...
                ArbreOld newFils = new ArbreOld(jeuBase, moves.get(i), false);
            ...
            for(int i = 0; i < moves.size(); i++) {
                ...
                ArbreOld newFils = new ArbreOld(jeuBase, moves.get(i), true);
    ...
    float SearchAlphaBeta(int depth, ArbreOld arbreCourant, float alpha, float beta){
//        Statistics.incrementConfigurationsLookedAt();
//        if(depth == 0){
